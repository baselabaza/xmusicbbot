import logging
from xmusicbbot.modules.msg import Messages as tr
from pyrogram import Client, filters
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, Message
from xmusicbbot.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL,BOT_USERNAME
...
@Client.on_message(filters.command(["start","start@xmusicbbot"]) & ~filters.private & ~filters.channel)
...
@Client.on_message(filters.command(["help","help@xmusicbbot"]) & ~filters.private & ~filters.channel)
